...
and morphism_desc =
  ...
  | Morphism_concat of {
      morphism_left : morphism;
      morphism_right : m_comp;
    }

and m_comp = m_comp_desc node

and m_comp_desc =
  | M_comp_term of m_term
  | M_comp_name of name
...
and d_concat_desc =
  ...
  | D_concat_concat of {
      d_concat_left : d_concat;
      d_concat_right : d_expr;
    }
...
val node : ?span:Positions.span -> 'a -> 'a node
val empty : program
