...
\begin{itemize}
  \item $\cells : \GIds \rightharpoonup (\mathbb{N} \times \CData)$ maps
...
\begin{itemize}
  ...
  \item $\mathit{locals} : \Namespace \rightharpoonup (\mathbb{N} \times \CData)$
...
(the combinatorial shapes), diagrams (labelled shapes with paste
history), and partial maps (structure-preserving maps between them).
